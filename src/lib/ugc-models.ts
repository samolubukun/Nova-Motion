...
export const UGC_MODELS: UGCModel[] = [
  ...
  },
  {
    ...
    provider: "xAI",
    description:
      "Fast, lifelike video generation with synchronized audio. Strong for high-CTR hooks.",
    ...
    resolutions: ["480p", "720p"],
    defaultResolution: "480p",
    notes: "WaveSpeed only supports 6s or 10s clips and 16:9 / 1:1 / 9:16 ratios; mode presets are not available.",
  },
  {
    id: "happy-horse",
    label: "Happy Horse 1",
